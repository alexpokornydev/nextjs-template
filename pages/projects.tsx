...
export default function MainPage(){
    ...
    return(
        <Layout>
            <Head>
                <title>Alex Pokorný • Hotové projekty</title>
                ...
                <div className="absolute inset-0 flex flex-col justify-center">
                    ...
                    <div className="container mx-auto text-center relative z-[9] px-8 mb-9 md:px-12 lg:px-24" data-aos="fade-in" data-aos-duration="2000">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 mt-36">
                            <span className="bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text block">Seznam všech</span>
                            <span className="text-white">projektů</span>
                        </h1>

                        <p className="text-gray-400 text-xl max-w-3xl mx-auto mb-12">
                            Seznam všech mých dokončených projektů.
                        </p>
                    </div>
                </div>
            </section>

            <section id="projects" className="relative py-20 px-2 md:px-12">
                ...
                <div className="relative">
                    <div className="flex flex-col justify-center gap-y-2">
                        <div data-aos="fade-in" data-aos-duration="2000">
                            <div className="flex flex-col justify-center gap-y-2">
                                <span className="block mx-auto px-6 py-2 mb-3 rounded-full bg-primary/10 text-primary text-md transition-colors duration-500 hover:bg-primary/20">Celkově je zde <strong>{projects.length}</strong> projektů</span>
                    ...
                    <div className="flex flex-wrap justify-center gap-8 mt-9">
                        {!isLoading && !hasError && projects.map(proj => (
